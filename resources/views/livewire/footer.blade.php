      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="mb-10 w-full">
            <a href="javascript:void(0)" class="mb-2 inline-block max-w-[160px]">
                <h4 class="text-dark mb-8 text-lg font-semibold">Love TALL-stack</h4>
            </a>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
          <div class="mb-10 w-full">
            ...
            <p class="text-body-color text-base">&copy; 2023 CodeWithPranta</p>
          </div>
        </div>
      </div>
    </div>
